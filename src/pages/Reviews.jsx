...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    review:
      "Super Health feels more advanced than regular turmeric supplements. My knee discomfort during workouts has reduced dramatically.",
  },
  {
    name: "Priya Nair",
    ...
    >
      <Container maxWidth="md">
        ...
        <Box textAlign="center" mt={8}>
          <Typography variant="body2" color="text.secondary">
            *Results may vary. Super Health is a nutraceutical supplement and
