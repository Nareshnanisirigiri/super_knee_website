...
const resultTimeline = [

  {
    ...
    title: "Start Daily Sachet Routine",
    description:
      "Dissolve one Super Health sachet in water after food. The clinically studied ingredients begin supporting anti-inflammatory pathways in the body.",
    icon: LocalDrinkOutlinedIcon
  },
    ...
    <Box sx={{ mt: { xs: 8, md: 10 } }}>
      ...
      >
        ...
        <Box
          component="img"
          src={poster}
          alt="Super Health measurable results poster"
          sx={{
            width: "100%",
            maxWidth: 900,
            borderRadius: 6,
      ...
      >
        ...
        >
          Super Health works through multiple clinically studied pathways.
          This flow shows how the once-daily sachet routine supports joint
          comfort and mobility over time.
        </Typography>
