...
//                 {[
//                   "Adults (40+) experiencing mild to moderate knee pain",
...
mb={3}
>
WHO SHOULD USE SUPER HEALTH?
</Typography>

<Typography mb={4} color="text.secondary">
Super Health is ideal for people looking to maintain healthy
joints, reduce stiffness and support long-term mobility.
</Typography>
...
<Typography sx={{ display: "flex", gap: 1, mb: 1 }}>
<WarningAmberIcon color="warning" />
Super Health is a nutraceutical supplement, not a medicine
</Typography>
